...
{
    public class RevenueBreakdownByTruckReportByTicketsDataService_Tests : AppTestBase, IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            _officeId = office.Id;
            _revenueBreakdownByTruckReportDataService = Resolve<IRevenueBreakdownByTruckReportByTicketsDataService>();
        ...
        public async Task Test_GetRevenueBreakdownItems_should_return_one_item_for_each_Truck()
        {
            ...
            await CreateTicket(orderLine11, truck1, "1", 10);
            await CreateTicket(orderLine12, truck1, "2", 20);
