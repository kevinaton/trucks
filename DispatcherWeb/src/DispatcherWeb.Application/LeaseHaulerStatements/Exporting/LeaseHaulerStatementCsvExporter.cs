...
namespace DispatcherWeb.LeaseHaulerStatements.Exporting
{
    public class LeaseHaulerStatementCsvExporter : CsvExporterBase, ILeaseHaulerStatementCsvExporter
    {
        ...
        public FileBytesDto ExportToFileBytes(LeaseHaulerStatementReportDto data)
        {
            return CreateCsvFileBytes(
                data.FileName,
                () =>
                {
                    FillCsvFile(data);
        ...
        private void FillCsvFile(LeaseHaulerStatementReportDto data)
        {
