...
namespace DispatcherWeb.Web.Startup
{
    ...
    public class DispatcherWebWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DispatcherWebWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DispatcherWebWebHostModule).GetAssembly());
        }
