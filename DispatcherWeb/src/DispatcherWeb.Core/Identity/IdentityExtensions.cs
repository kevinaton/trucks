...
namespace DispatcherWeb.Identity
{
    public static class IdentityExtensions
    {
        ...
        public static int GetTenantId(this UserIdentifier userIdentifier)
        {
            if (userIdentifier?.TenantId != null)
            {
                return userIdentifier.TenantId.Value;
            }
            throw new ArgumentException("TenantId", "TenantId is required");
        }
    }
}