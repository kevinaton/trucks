...
namespace DispatcherWeb.Authorization.Users
{
    ...
    public class UserEmailer : DispatcherWebServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        private string _emailButtonStyle =
            "padding-left: 48px; padding-right: 48px; padding-top: 12px; padding-bottom: 12px; color: #ffffff; background-color: #67A2D7; font-size: 11pt; text-decoration: none;";
        private string _emailButtonColor = "#67A2D7";
