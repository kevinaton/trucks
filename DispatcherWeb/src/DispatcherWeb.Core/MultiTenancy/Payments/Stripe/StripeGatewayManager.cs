...
{
    public class StripeGatewayManager : DispatcherWebServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "DispatcherWeb";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + DispatcherWebConsts.Currency;
        }
