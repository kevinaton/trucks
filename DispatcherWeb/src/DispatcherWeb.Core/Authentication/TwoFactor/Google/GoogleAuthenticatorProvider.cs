...
{
    public class GoogleAuthenticatorProvider : DispatcherWebServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("DispatcherWeb", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
