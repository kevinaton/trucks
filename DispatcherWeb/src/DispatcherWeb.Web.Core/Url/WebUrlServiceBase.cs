...
namespace DispatcherWeb.Web.Url
{
    public abstract class WebUrlServiceBase
    {
        ...
        public string WebSiteRootAddressFormat => _appConfiguration[WebSiteRootAddressFormatKey] ?? "https://localhost:44332/";

        public string ServerRootAddressFormat => _appConfiguration[ServerRootAddressFormatKey] ?? "https://localhost:44332/";
