...
namespace DispatcherWeb.Web.Public.Startup
{
    ...
    public class DispatcherWebWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public DispatcherWebWebFrontEndModule(IWebHostEnvironment env, DispatcherWebEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DispatcherWebWebFrontEndModule).GetAssembly());
        }
    }
}
