    ...
    $(function () {
        ...
        var organizationTree = {
            ...
            generateTextOnTree: function (ou) {
                ...
                //return '<span title="' + ou.code + '" class="ou-text' + itemClass + ' text-ellipsis" data-ou-id="' + ou.id + '"><span class="text-ellipsis">' + app.htmlUtils.htmlEncodeText(ou.displayName) + '</span><span> (<span class="ou-text-member-count">' + ou.memberCount + '</span>) <i class="fa fa-caret-down text-muted"></i></span></span>';

                return '<div title="' + ou.code + '" class="ou-text' + itemClass + ' text-ellipsis" data-ou-id="' + ou.id + '">' + app.htmlUtils.htmlEncodeText(ou.displayName) + '</div><div style="float: left;"> (<span class="ou-text-member-count">' + ou.memberCount + '</span>) <i class="fa fa-caret-down text-muted"></i></div>';
        ...
        var members = {
            ...
            init: function () {
                this.dataTable = members.$table.find(".organization-members-table").DataTableInit({
                    paging: true,
                    serverSide: true,
                    processing: true,
