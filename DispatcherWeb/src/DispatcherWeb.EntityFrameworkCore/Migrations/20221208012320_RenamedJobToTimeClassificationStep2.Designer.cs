...
namespace DispatcherWeb.Migrations
{
    ...
    [Migration("20221208012320_RenamedJobToTimeClassificationStep2")]
    partial class RenamedJobToTimeClassificationStep2
    {
            ...
            modelBuilder.Entity("DispatcherWeb.Drivers.EmployeeTime", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.TimeClassifications.TimeClassification", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
