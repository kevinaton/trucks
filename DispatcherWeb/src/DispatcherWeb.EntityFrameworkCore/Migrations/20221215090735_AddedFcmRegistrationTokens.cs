...
{
    public partial class AddedFcmRegistrationTokens : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobilePlatform = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FcmRegistrationToken_AbpUsers_UserId",
                        column: x => x.UserId,
