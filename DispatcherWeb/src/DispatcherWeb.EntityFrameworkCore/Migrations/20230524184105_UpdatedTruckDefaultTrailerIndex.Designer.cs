...
namespace DispatcherWeb.Migrations
{
    ...
    [Migration("20230524184105_UpdatedTruckDefaultTrailerIndex")]
    partial class UpdatedTruckDefaultTrailerIndex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DispatcherWeb.Customers.Customer", b =>
                {
                    ...
                    b.Property<int?>("MaterialCompanyTenantId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.DailyFuelCosts.DailyFuelCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Dispatching.Dispatch", b =>
                {
                    ...
                    b.Property<int?>("OrderLineTruckId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Drivers.Driver", b =>
                {
                    ...
                    b.Property<int?>("HaulingCompanyDriverId")
                        .HasColumnType("int");

                    b.Property<int?>("HaulingCompanyTenantId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Drivers.EmployeeTime", b =>
                {
                    ...
                    b.Property<decimal?>("ManualHourAmount")
            ...
            modelBuilder.Entity("DispatcherWeb.Drivers.EmployeeTimeClassification", b =>
                {
                    ...
                    b.Property<bool>("AllowForManualTime")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DispatcherWeb.Invoices.Invoice", b =>
                {
                    ...
                    b.Property<DateTime?>("QuickbooksExportDateTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("QuickbooksInvoiceId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ShowFuelSurchargeOnInvoice")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Invoices.InvoiceLine", b =>
                {
                    ...
                    b.Property<int?>("ChildInvoiceLineKind")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ParentInvoiceLineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentInvoiceLineId");
            ...
            modelBuilder.Entity("DispatcherWeb.LeaseHaulers.LeaseHaulerTruck", b =>
                {
                    ...
                    b.Property<bool>("AlwaysShowOnSchedule")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DispatcherWeb.LuckStone.LuckStoneEarnings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("FscAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("HaulPayment")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("HaulPaymentRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("HaulPaymentRateUom")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("HaulerRef")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("LuckStoneEarnings");
                });

            modelBuilder.Entity("DispatcherWeb.LuckStone.LuckStoneEarningsBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LuckStoneEarningsBatch");
                });

            modelBuilder.Entity("DispatcherWeb.LuckStone.LuckStoneLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Orders.Order", b =>
                {
                    ...
                    b.Property<bool>("HasLinkedHaulingCompanyOrders")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("MaterialCompanyOrderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Orders.OrderLine", b =>
                {
                    ...
                    b.Property<int?>("MaterialCompanyOrderLineId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Orders.Ticket", b =>
                {
                    ...
                    b.Property<int?>("HaulingCompanyTicketId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MaterialCompanyTicketId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.PayStatements.PayStatementTicket", b =>
                {
                    ...
                    b.Property<int>("DriverIsPaidForLoadBasedOn")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.TimeClassifications.TimeClassification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Trucks.TrailerAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Trucks.Truck", b =>
                {
                    ...
                    b.Property<int?>("HaulingCompanyTruckId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.VehicleCategories.VehicleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.WebPush.FcmPushMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("FcmRegistrationTokenId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ReceivedAtDateTime")
                        .HasColumnType("datetime2");

                    b.Property<int?>("ReceiverDriverId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FcmRegistrationTokenId");

                    b.HasIndex("ReceiverDriverId");

                    b.HasIndex("ReceiverUserId");

                    b.ToTable("FcmPushMessage");
                });

            modelBuilder.Entity("DispatcherWeb.WebPush.FcmRegistrationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DispatcherWeb.Dispatching.Dispatch", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Orders.OrderLineTruck", "OrderLineTruck")
                        .WithMany("Dispatches")
                        .HasForeignKey("OrderLineTruckId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DispatcherWeb.Drivers.DriverMessage", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Sms.SentSms", "SentSms")
                        .WithMany()
                        .HasForeignKey("SentSmsId");
            ...
            modelBuilder.Entity("DispatcherWeb.Drivers.EmployeeTime", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.TimeClassifications.TimeClassification", "TimeClassification")
                        .WithMany()
                        .HasForeignKey("TimeClassificationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DispatcherWeb.TimeOffs.TimeOff", "TimeOff")
            ...
            modelBuilder.Entity("DispatcherWeb.Invoices.InvoiceLine", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Invoices.InvoiceLine", "ParentInvoiceLine")
                        .WithMany()
                        .HasForeignKey("ParentInvoiceLineId");
                    ...
                    b.Navigation("ParentInvoiceLine");
            ...
            modelBuilder.Entity("DispatcherWeb.LuckStone.LuckStoneEarnings", b =>
                {
                    b.HasOne("DispatcherWeb.LuckStone.LuckStoneEarningsBatch", "Batch")
                        .WithMany("LuckStoneEarnings")
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DispatcherWeb.Orders.Order", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.FuelSurchargeCalculations.FuelSurchargeCalculation", "FuelSurchargeCalculation")
                        .WithMany("Orders")
                        .HasForeignKey("FuelSurchargeCalculationId");
            ...
            modelBuilder.Entity("DispatcherWeb.Orders.Ticket", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Dispatching.Load", "Load")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("DispatcherWeb.Trucks.TrailerAssignment", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Trucks.Truck", "Tractor")
                        .WithMany("TrailerAssignmentsOfTractor")
                        .HasForeignKey("TractorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DispatcherWeb.Trucks.Truck", "Trailer")
                        .WithMany("TrailerAssignmentsOfTrailer")
                        .HasForeignKey("TrailerId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DispatcherWeb.WebPush.FcmPushMessage", b =>
                {
                    b.HasOne("DispatcherWeb.WebPush.FcmRegistrationToken", "FcmRegistrationToken")
                        .WithMany()
                        .HasForeignKey("FcmRegistrationTokenId");

                    b.HasOne("DispatcherWeb.Drivers.Driver", "ReceiverDriver")
                        .WithMany()
                        .HasForeignKey("ReceiverDriverId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DispatcherWeb.Authorization.Users.User", "ReceiverUser")
                        .WithMany()
                        .HasForeignKey("ReceiverUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FcmRegistrationToken");
            ...
            modelBuilder.Entity("DispatcherWeb.LuckStone.LuckStoneEarningsBatch", b =>
                {
                    b.Navigation("LuckStoneEarnings");
                });
            ...
            modelBuilder.Entity("DispatcherWeb.Trucks.Truck", b =>
                {
                    ...
                    b.Navigation("TrailerAssignmentsOfTractor");

                    b.Navigation("TrailerAssignmentsOfTrailer");
