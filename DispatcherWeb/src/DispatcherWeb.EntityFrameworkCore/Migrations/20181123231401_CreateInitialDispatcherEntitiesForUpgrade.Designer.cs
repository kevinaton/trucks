...
namespace DispatcherWeb.Migrations
{
    ...
    [Migration("20181123231401_CreateInitialDispatcherEntitiesForUpgrade")]
    partial class CreateInitialDispatcherEntitiesForUpgrade
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DispatcherWeb.LeaseHaulerAgreements.LeaseHaulerAgreement", b =>
                {
                    ...
                    b.Property<int?>("LeaseHaulerContactId1");

                    b.Property<int>("LeaseHaulerId");

                    b.Property<int?>("LeaseHaulerId1");
                    ...
                    b.HasIndex("LeaseHaulerContactId1");

                    b.HasIndex("LeaseHaulerId");

                    b.HasIndex("LeaseHaulerId1");
            ...
            modelBuilder.Entity("DispatcherWeb.LeaseHaulerAgreements.LeaseHaulerAgreementService", b =>
                {
                    ...
                    b.Property<int?>("LeaseHaulerAgreementId1");
                    ...
                    b.HasIndex("LeaseHaulerAgreementId1");
            ...
            modelBuilder.Entity("DispatcherWeb.Orders.Order", b =>
                {
                    ...
                    b.Property<long?>("AuthorizationCaptureTransactionId");

                    b.Property<DateTime?>("AuthorizationDateTime");

                    b.Property<long?>("AuthorizationTransactionId");
            ...
            modelBuilder.Entity("DispatcherWeb.Projects.Project", b =>
                {
                    ...
                    b.Property<int?>("CustomerContactId1");
            ...
            modelBuilder.Entity("DispatcherWeb.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Offices.Office")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("DispatcherWeb.Drivers.DriverAssignment", b =>
                {
                    b.HasOne("DispatcherWeb.Drivers.Driver")
                        .WithMany()
                    ...
                    b.HasOne("DispatcherWeb.Trucks.Truck")
            ...
            modelBuilder.Entity("DispatcherWeb.Emailing.OrderEmail", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Orders.Order")
                        .WithMany("OrderEmails")
            ...
            modelBuilder.Entity("DispatcherWeb.LeaseHaulerAgreements.LeaseHaulerAgreement", b =>
                {
                    b.HasOne("DispatcherWeb.LeaseHaulers.LeaseHaulerContact")
                        .WithMany()
                    ...
                    b.HasOne("DispatcherWeb.LeaseHaulers.LeaseHaulerContact", "LeaseHaulerContact")
                        .WithMany()
                        .HasForeignKey("LeaseHaulerContactId1");

                    b.HasOne("DispatcherWeb.LeaseHaulers.LeaseHauler")
                        .WithMany()
                    ...
                    b.HasOne("DispatcherWeb.LeaseHaulers.LeaseHauler", "LeaseHauler")
                        .WithMany()
                        .HasForeignKey("LeaseHaulerId1");

                    b.HasOne("DispatcherWeb.Projects.Project")
            ...
            modelBuilder.Entity("DispatcherWeb.LeaseHaulerAgreements.LeaseHaulerAgreementService", b =>
                {
                    b.HasOne("DispatcherWeb.LeaseHaulerAgreements.LeaseHaulerAgreement")
                    ...
                    b.HasOne("DispatcherWeb.LeaseHaulerAgreements.LeaseHaulerAgreement", "LeaseHaulerAgreement")
                        .WithMany()
                        .HasForeignKey("LeaseHaulerAgreementId1");

                    b.HasOne("DispatcherWeb.Services.Service")
                        .WithMany()
                    ...
                    b.HasOne("DispatcherWeb.Suppliers.Supplier")
                        .WithMany()
                    ...
                    b.HasOne("DispatcherWeb.UnitsOfMeasure.UnitOfMeasure")
                        .WithMany()
            ...
            modelBuilder.Entity("DispatcherWeb.Orders.Order", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Customers.Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DispatcherWeb.Projects.Project", b =>
                {
                    ...
                    b.HasOne("DispatcherWeb.Customers.CustomerContact")
                        .WithMany("Projects")
                        .HasForeignKey("CustomerContactId1");
