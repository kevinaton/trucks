...
namespace DispatcherWeb
{
    public class DispatcherWebConsts
    {
        ...
        public static class DefaultSettings
        {
            ...
            {
                public const string DefaultNotes = @"Loads must be maintained in compliance with all Federal, State, and Local DOT regulations for weight and containment of material.
...
(Surcharge will not be added until fuel cost exceed {BaseFuelCost+15} per gallon)";
                ...
                public const string GeneralTermsAndConditions = @"GENERAL TERMS AND CONDITIONS
